...
import type { ApiInterface } from "../api-client/index.js";
...
const getTagInfoFromValues = ({ apiClient, now, tagContentTypes, tagEpc, contentId: contentTypeId, contentValue: ContentValue }: {
    apiClient?: ApiInterface<any, any, any, any>;
    tagEpc: string;
    tagContentTypes: TagContentTypeWithData[];
    now?: boolean;
...
export const findTagInfo = ({ tagContentTypes, now, tagEpc, apiClient, virtualEpcsBodyKey, virtualEpcsFetchUrl }: FindTagProps): TagInfo | MaybeVirtual | null => {
